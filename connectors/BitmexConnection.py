...
class BitmexConnection:
    ...
    def _make_request(self, method: str, endpoint: str, data: typing.Dict):
        ...
        if response.status_code == 200:
            ...
            logger.error("Error while making %s request to %s: %s(error status code %s)", method , endpoint , response.json(),response.status_code)
            return None
    ...
    def place_order(self, contract: Contract, order_type: str, quantity: int,  side: str, price=None, tif = None) ->OrderStatus:
        ...
        if order_status is not None:
            ...
            logger.info("Bitmex order placed")
        return order_status
            ...
            if data['table'] == 'instrument':
                ...
                for d in data['data']:
                    ...
                    try:
                        ...
                        logger.error("Error while looping through bitmex strategies: %s", e)
